...
- **Name**: A name for your evaluation. This is for your reference and will be displayed in the dashboard. *This field is required.*
...
Evaluation scores are automatically normalized and displayed on a scale from 0 to 1 for consistent comparison across different metrics.
