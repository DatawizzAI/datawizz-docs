...
1. **Public Plugins**: Pre-built plugins provided by Datawizz for common use cases (content filtering, PII detection, etc.) - see [Public Plugins](/public-plugins/index) for the full catalog.
